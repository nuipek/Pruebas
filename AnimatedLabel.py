...
import sys,re    
from PyQt5.QtWidgets import QStyleFactory, QApplication, QMainWindow,QPushButton,QLineEdit, QMenu, QLabel,QDialog,QFormLayout
...
class AnimatedLabel(QLabel):
    ...
    """
    AQUI DEFINIMOS LA VARIABLE QUE SE QUIERE ANIMAR CON EL TIPO DE OBJETO SU GETTER Y SU SETTER
    """
